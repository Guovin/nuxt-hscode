<template>
  <div class="detail">
    <!-- 卡片视图区域 -->
    <!-- 卡片视图区 -->
    <div v-for="(list,index) in goodList"
         :key="index">
      <div class="container">
        <el-row>
          <el-col :span="12"
            ...
            <el-card>
              ...
              <div class="hoverColor">
                <div class="span_right">
                  ...
                  <span style="font-size: 18px;font-weight: bolder;color: #909399;"
                        v-else>无</span>
                </div>
              </div>
              <div class="hoverColor">
            ...
            <el-card>
              ...
              <div class="hoverColor">
                <span style="font-size: 18px;color: #909399;"
                      v-if="list.regulatory_code === '' ">暂无</span>
                <div v-else
        ...
        <el-row>
          <el-col :span="12">
            ...
            <el-card>
              ...
              <div class="hoverColor">
                <span style="font-size: 18px;color: #909399;"
                      v-if="list.element_require === '' ">暂无</span>
                <div v-else
                  ...
                  <el-row>
                    ...
                    <el-col :span="22"
                            class="detail_right"><span style="font-size: 18px;font-weight: bold;color: #606266;">{{item}}</span>
                    </el-col>
                  </el-row>
                </div>
                <!-- 申报要素样例 -->
                <div class="hoverColor">
                  <el-row type="flex"
                          ...
                          class="div_detail">
                    <el-col :span="4"
                            class="detail_left"><span style="font-size: 15px;font-weight: bold;color: #606266;line-height:40px;">申报要素样例</span>
                    </el-col>
                    <el-col :span="20"
                            class="detail_right"><span v-if="example !== ''"
                            style="font-size: 10px;font-weight: bolder;line-height:40px;">{{example}}</span>
                      <span v-else
                            style="font-size: 18px;font-weight: bolder;color: #909399;">无</span>
                    </el-col>
                  </el-row>
                </div>
              </div>
