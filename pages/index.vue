  ...
  <div class="home">
      ...
      <el-header>
        <div class="flexRow">
          ...
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item
              v-if="
                this.$route.path === '/table' || this.$route.path === '/detail'
              "
              ><i class="iconfont iconsousuo"></i>搜索结果
            </el-breadcrumb-item>
            <el-breadcrumb-item v-if="this.$route.path === '/detail'"
              ><i class="iconfont iconpicixiangqing"></i>内容详情
            </el-breadcrumb-item>
            <el-breadcrumb-item v-if="this.$route.path === '/barcode'"
        ...
        <el-card v-if="this.$route.path === '/'" class="treeCard">
          <transition name="emerge" appear>
            <keep-alive>
              <div class="hot_card">
                <div class="hot_title">
                  <i class="iconfont iconremen"></i>热门HSCode商品编码
                </div>
                <el-row :gutter="8">
                  <el-col
                ...
                <el-row class="showMoreRow">
                  ...
                  <el-col :span="5">
                    ...
                    >
                      ...
                      <i
                        :class="
                          closeMore ? 'el-icon-arrow-up' : 'el-icon-arrow-down'
                        "
                      ></i>
                    </div>
                  </el-col>
    ...
    >
      <div class="history_message" ref="history_div">
        <div v-if="nothingTip" class="nothing_tip">
          <span class="tip_content">无反馈记录</span>
        </div>
        <div
          class="sent_message"
          v-for="(message, index) in myCookie"
          :key="index"
        >
  ...
  methods: {
    ...
    async getKey() {
      if (this.key !== "") {
        ...
        const { data: res } = await this.$http.post(
          `search?keyword=${encodeURIComponent(this.key)}`
        );
        if (res.code !== 200) {
    ...
    loadNode(node, resolve) {
      ...
      data.forEach((value) => {
        ...
        children.push({
          class: value.sub_class,
          leaf: true,
          prefix: value.hscode_prefix,
        });
      });
      resolve(children);
    },
    ...
    statistic() {
      if (process.client) {
        ...
        (function () {
          ...
          hm.src =
            "https://hm.baidu.com/hm.js?2f646b2e73936a9ab950f9adfa665211";
    ...
    getCookie() {
      if (process.client) {
        ...
        if (this.myCookie.length != 0) {
          ...
          this.form.name = this.myCookie[this.myCookie.length - 1]
            .split(",")[0]
            .trim();
        }
      }
